...
namespace CapFrameX.PMD
{
    ...
    public static class PmdChannelExtensions
    {
        ...
        public static int[] GPUSlotVoltageIndexGroup { get; private set; }

        public static int[] GPUSlotPowerIndexGroup { get; private set; }
