	...
	public class OverlayViewModel : BindableBase, INavigationAware
	{
		...
		public int SelectedNumberOfRuns
		{
			...
			set
			{
				...
				RaisePropertyChanged();
				RaisePropertyChanged(nameof(AggregationRunsItems));
		...
		public Array ThirdMetricItems => Enum.GetValues(typeof(EMetric))
											 ...
											 .ToArray();
		public Array HistoryRunsItems => Enumerable.Range(2, 4).ToArray();

		public Array AggregationRunsItems => Enumerable.Range(2, SelectedNumberOfRuns - 1).ToArray();
