...
{
    private readonly PawnIo _pawnIo = PawnIo.LoadModuleFromResource(typeof(AmdFamily0F).Assembly, $"{nameof(CapFrameX.Service.Monitoring)}.Resources.PawnIo.AMDFamily17.bin");
